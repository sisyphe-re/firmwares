{
  ...
  outputs = { self, nixpkgs, rgrunbla }: {
    packages.x86_64-linux.gnrc_border_router =
      ...
      callPackage ./firmware_builder { fetchSWH = rgrunbla.lib.fetchSWH; firmware_name = "gnrc_border_router"; firmware_path = ./src; outputHash = "sha256-fejWaUj+YzooTsIQ4qB+ZhJ/lZgMhaZa1FppNqoAyNQ="; };

    packages.x86_64-linux.gnrc_networking =
      with import nixpkgs { system = "x86_64-linux"; };
      callPackage ./firmware_builder { fetchSWH = rgrunbla.lib.fetchSWH; firmware_name = "gnrc_networking"; firmware_path = ./src; outputHash = "sha256-Se6Dji2eLrdgGayRqJzzdKIsTKsom/bGLZVB5virhRQ="; };
